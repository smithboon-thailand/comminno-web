              ...
              sections: [
                {
                  ...
                  description:
                    "Comm.Inno เป็นศูนย์วิจัยของจุฬาลงกรณ์มหาวิทยาลัย ปฏิบัติตาม พ.ร.บ. คุ้มครองข้อมูลส่วนบุคคล (PDPA) เราไม่โหลดเครื่องมือติดตามจากบุคคลที่สามเพื่อการตลาด ด้านล่างคุณเลือกได้ว่าจะอนุญาตการนับจำนวนผู้เข้าชมแบบไม่ระบุตัวตนหรือไม่ คุกกี้อื่น ๆ จำเป็นต่อการใช้งานเว็บไซต์",
                },
                {
