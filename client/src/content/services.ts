...
export const services: readonly ServiceWithCopy[] = [
  ...
  },
  {
    ...
    "sdgNumber": 17,
    "descriptionEn": "We design research and evaluation projects that work as evidence — defensible methodology, validated instruments, transparent analysis, and reports written so that decision-makers can act on them. Our team holds doctorates in communication, sport science, and political science, and publishes regularly in peer-reviewed journals. Whether you need a baseline survey before a public-health campaign, a process evaluation halfway through a multi-year program, or an impact assessment for a funder, we scope the right design for your question and budget.",
    "descriptionTh": "เราออกแบบโครงการวิจัยและประเมินผลที่ทำงานในฐานะหลักฐาน — มีระเบียบวิธีที่ยืนยันได้ เครื่องมือที่ผ่านการทดสอบความเที่ยง การวิเคราะห์ที่โปร่งใส และรายงานที่เขียนให้ผู้ตัดสินใจนำไปใช้ได้จริง ทีมของเราจบเอกด้านการสื่อสาร วิทยาศาสตร์การกีฬา และรัฐศาสตร์ และตีพิมพ์งานในวารสารที่ผ่านการทบทวนเป็นประจำ ไม่ว่าคุณต้องการสำรวจฐานก่อนเริ่มแคมเปญสาธารณสุข ประเมินกระบวนการกลางทาง หรือประเมินผลกระทบเพื่อรายงานต่อผู้ให้ทุน เราออกแบบให้เหมาะกับคำถามและงบประมาณของคุณ",
    "deliverablesEn": [
      "Research framework",
  ...
  },
  {
    ...
    "sdgNumber": 17,
    "descriptionEn": "We run seminars, expert forums, and stakeholder consultations end-to-end: agenda design, speaker invitations, venue logistics, equipment, live moderation, real-time synthesis, and a written report that captures what the room actually decided.\n\nThe brief usually comes from clients who have hosted events before and got back nothing but feedback forms. Our differentiator is the synthesis — we treat every seminar as a research event with a discussable output, not a content delivery vehicle.",
    "descriptionTh": "เราจัดสัมมนา การประชุมผู้เชี่ยวชาญ และเวทีรับฟังผู้มีส่วนได้เสียครบวงจร — ตั้งแต่ออกแบบกำหนดการ เชิญวิทยากร จัดสถานที่และอุปกรณ์ ดำเนินรายการสด สังเคราะห์ข้อมูลขณะประชุม จนถึงเขียนรายงานบันทึกข้อสรุปที่ห้องประชุมเห็นพ้อง\n\nลูกค้าที่มาหาเรามักเคยจัดงานแบบเดิม ๆ แล้วได้กลับไปแค่แบบประเมินผู้เข้าร่วม จุดที่เราต่างคือเรามองทุกสัมมนาเป็นกิจกรรมวิจัยที่มีผลผลิตให้นำไปอภิปรายต่อ ไม่ใช่แค่เวทีส่งสาร",
    "deliverablesEn": [
      "Agenda design",
