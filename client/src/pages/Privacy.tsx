...
const EN_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "Data Protection Officer, Center of Excellence in Communication Innovation. Email: [dpo@comminno.center]. Phone: [+66 2 218 ____].",
      },
    ],
  },
];
...
const TH_SECTIONS: Section[] = [
  ...
  },
  {
    ...
    blocks: [
      {
        kind: "p",
        text: "สำหรับคำถาม คำขอ และข้อร้องเรียนเกี่ยวกับความเป็นส่วนตัว ติดต่อเจ้าหน้าที่คุ้มครองข้อมูลส่วนบุคคล (DPO) ศูนย์ความเป็นเลิศด้านนวัตกรรมการสื่อสาร อีเมล: [dpo@comminno.center] โทรศัพท์: [02-218-____]",
      },
    ],
  },
];
...
const COPY = {
  th: {
    ...
    intro:
      'ศูนย์ความเป็นเลิศด้านนวัตกรรมการสื่อสารเพื่อการพัฒนาคุณภาพชีวิตและความยั่งยืน (ต่อไปนี้เรียกว่า "ศูนย์ฯ" หรือ "เรา") ให้ความสำคัญกับความเป็นส่วนตัวของท่าน และมุ่งคุ้มครองข้อมูลส่วนบุคคลของท่านอย่างเคร่งครัด นโยบายฉบับนี้ชี้แจงวิธีที่เราเก็บรวบรวม ใช้ จัดเก็บ เปิดเผย และปกป้องข้อมูล พร้อมระบุสิทธิของท่านตามพระราชบัญญัติคุ้มครองข้อมูลส่วนบุคคล พ.ศ. 2562 (ต่อไปนี้เรียกว่า "PDPA")',
    effective: "วันที่มีผลบังคับ",
    updated: "อัปเดตล่าสุด",
    cookieSettings: "เปิดการตั้งค่าคุกกี้",
    metaDesc:
      "นโยบายความเป็นส่วนตัวของศูนย์ความเป็นเลิศด้านนวัตกรรมการสื่อสาร — เก็บอะไร ใช้ทำอะไร เก็บนานเท่าใด สิทธิของท่านตาม PDPA และวิธีติดต่อเจ้าหน้าที่คุ้มครองข้อมูล",
  },
  en: {
    title: "Privacy policy",
    lede: "Full PDPA-compliant notice for the Center of Excellence in Communication Innovation.",
    crumbHome: "Home",
