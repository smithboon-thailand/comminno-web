...
const FORBIDDEN_STRINGS = [
  { re: /(?<!\.)comminno@chula\.ac\.th/, why: "the center's email is comm.inno@chula.ac.th WITH a dot — read it from client/src/lib/contact.ts" },
  ...
  { re: /218[\s\-]?2215/, why: "the center's phone is +66 2 218 2163 — read it from client/src/lib/contact.ts" },
];
